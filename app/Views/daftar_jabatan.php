...
<div class="card shadow">
    <div class="row card-header bg-primary p-2 m-0">
        <div class="col-lg-6 col-xl-6 col-md-6 col-xs-6 col-sm-6 col-6">
            <h4 class="text-white mt-2">List Department</h4>
        </div>

        <div class="col-lg-6 col-xl-6 col-md-6 col-xs-6 col-sm-6 col-6" align="right">
            <a href="../tambah_jabatan" class="btn btn-success btn-sm btn-icon-split mt-2">
            ...
            <table class="table table-hover display nowrap w-100" id="datatabelRole" cellspacing="0">
                <thead>
                    <tr class="first even" style="text-shadow: none; cursor: pointer;">
                        ...
                        <th style="text-align: center; vertical-align: middle; margin: 5px; padding: 7px;">DEPARTMENT NAME</th>
