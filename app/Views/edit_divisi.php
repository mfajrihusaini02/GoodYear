            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-6 col-md-6 col-xs-12 col-sm-12 col-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php if (session('validation.nama_divisi')) : ?> is-invalid <?php endif ?>" id="nama_divisi" name="nama_divisi" maxlength="100" autofocus placeholder="Please enter division name">
