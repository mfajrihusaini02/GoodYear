            ...
            <div class="col-lg-6 col-xl-6 col-md-6 col-xs-12 col-sm-12 col-12">
                <form method="POST" enctype="multipart/form-data" action="<?= base_url('simpan_karyawan') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php if (session('validation.nik')) : ?> is-invalid <?php endif ?>" id="nik" name="nik" maxlength="16" autofocus placeholder="Please enter NOCC" value="<?= old('nik'); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php if (session('validation.nama_karyawan')) : ?> is-invalid <?php endif ?>" id="nama_karyawan" name="nama_karyawan" maxlength="100" placeholder="Please enter employee name" value="<?= old('nama_karyawan'); ?>">
                        <div class="invalid-feedback">
