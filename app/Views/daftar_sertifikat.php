...
<div class="card shadow">
    <div class="row card-header bg-primary p-2 m-0">
        <div class="col-lg-6 col-xl-6 col-md-6 col-xs-6 col-sm-6 col-6">
            <h4 class="text-white mt-2">List Master Certificate</h4>
        </div>
            ...
            <table class="table table-hover display nowrap w-100" id="datatabelSertifikat" cellspacing="0">
                <thead>
                    <tr class="first even" style="text-shadow: none; cursor: pointer;">
                        ...
                        <th style="text-align: center; vertical-align: middle; margin: 5px; padding: 7px;">CERTIFICATE CODE</th>
                    ...
                    <?php foreach ($sertifikat as $value) : ?>
                        <tr style="vertical-align: middle; text-align: center; text-shadow: none;">
                            ...
                            <td style="margin: 5px; padding: 3px; text-align: center;">
                                <a href="<?= base_url('edit_sertifikat/'.$value['id_sertifikat']) ?>" class="btn btn-outline-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit">
                                    <span class='icon'><i class='fas fa-edit'></i></span>
                                </a>
                                <a href="#" data-href="<?= base_url('delete_sertifikat/'.$value['id_sertifikat']) ?>" onclick="confirmToDelete(this)" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete">
